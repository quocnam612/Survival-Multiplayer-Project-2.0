...
public class ChoppableTree : MonoBehaviourPunCallbacks
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            if (FindFirstObjectByType<InventorySystem>().handHold.transform.GetChild(0).gameObject.name.Contains("Axe")) {

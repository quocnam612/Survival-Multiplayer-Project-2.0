...
public class InventorySystem : MonoBehaviour
{
    ...
    // Example inventory items list for demonstration
    private List<string> inventoryItems = new List<string> { "Item1", "Item2", "Item3" };
    ...
    private void BatchUpdateInventoryUI()
    {
        ...
        {
            // Example: Update UI elements for each item
            GameObject itemUI = GetPooledObject(item);
            // Update itemUI with item details
        }
    }
